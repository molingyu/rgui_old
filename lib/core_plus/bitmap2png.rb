...
class Bitmap
  ...
  module Bitmap2PNG
    ...
    def make_png(bitmap_Fx)
      @bitmap_Fx = bitmap_Fx
      make_header + make_ihdr + make_idat + make_iend
    end
    #--------------------------------------------------------------------------
    # ● PNG文件头数据块
    #--------------------------------------------------------------------------
    ...
    def make_ihdr
      ...
      string = ih_sign + ih_width + ih_height + ih_bit_depth + ih_color_type +ih_compression_method + ih_filter_method + ih_interlace_method
...
#~       bitmap.dispose
    ...
    #-------------------------------------------------------------------------- 
    def make_iend
      [0x00,0x00,0x00,0x00,0x49,0x45,0x4E,0x44,0xAE,0x42,0x60,0x82].pack("C*")
      #ie_size = [0].pack("N")
      #ie_sign = "IEND"
